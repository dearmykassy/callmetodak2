...
const courses = [
  ...
  { name: "남성전용", prices: [["60분", "120,000원"], ["90분", "150,000원"]] },
] as const;
...
const faq = [
  ["지역을 어떻게 찾나요?", "서울·인천·경기와 천안·아산·청주·대전의 시·구 기준으로 안내를 준비하고 있습니다."],
  ["상담 전에 무엇을 알려주면 되나요?", "서비스를 받을 지역과 희망 시간, 원하는 코스를 알려주시면 됩니다."],
  ["결제는 어떻게 하나요?", "선입금 없이 현장에서 후불로 결제하며, 현장 카드 결제도 가능합니다."],
] as const;
